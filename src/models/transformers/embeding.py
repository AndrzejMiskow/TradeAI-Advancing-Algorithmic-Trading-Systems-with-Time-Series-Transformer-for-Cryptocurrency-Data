...
class VanillaPositionalEncoding(nn.Module):
    """
    This class implements the vanilla positional encoding layer used in the original transformer.
...
class PositionalEmbedding(nn.Module):
    """
    This class implements the positional embedding layer as described in Informer Paper
...
class DataEmbedding(nn.Module):
    def __init__(self, c_in, d_model, embed_type='fixed', freq='h', dropout=0.1):
        ...
        # self.position_embedding = VanillaPositionalEncoding(d_model=d_model)
